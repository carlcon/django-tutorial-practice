...
def create_question(question_text, days):
    """
    Create a question with the givent `question_text` and published the given number of `days`
...
class QuestionTextIndexViewTests(TestCase):
...
class QuestionTextDetailViewTests(TestCase):
    def test_future_question(self):
        """
